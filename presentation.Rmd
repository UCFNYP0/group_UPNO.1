...
**Monitoring System**
   ...
   **UHI** = T0(Temperature in the city) - T1 (Temperature in the rural)
**SUHI** = LST in the build-up area - LST in the non build-up area
...
```
**SUHI**: Surface Urban Heated Island
**UHI**：Urban Heated Island
---
### 2.1 Project approach
